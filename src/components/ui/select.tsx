...
export function SelectButton({
  ...
  return (
    <Listbox.Button
      id={id}
      className="relative w-full shadow-[inset_0_1px_1px_1px_#ffffff08] cursor-pointer text-sm font-semibold rounded dark:bg-white/5 bg-slate-400/5 py-2 pl-3 pr-10 text-left "
    >
